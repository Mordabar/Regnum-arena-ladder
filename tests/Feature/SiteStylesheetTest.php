...
it('publica la hoja del sitio con base, utilidades y variantes', function () {
    ...
    // El ladder ya no parte la pantalla en dos columnas -la tabla general se
    // queda con el ancho entero-, asi que la que se vigila es la del panel.
    expect($css)->toContain('xl\:grid-cols-\[1fr_330px\]');
