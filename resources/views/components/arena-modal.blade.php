...
>
    ...
    {{-- Panel --}}
    <div class="relative mx-4 w-full max-w-lg rounded-2xl border {{ $borderColor }} bg-[linear-gradient(180deg,rgba(40,28,20,0.98),rgba(14,10,8,0.99))] p-6 shadow-[0_25px_60px_rgba(0,0,0,0.5)] arena-modal-panel" style="animation: arenaModalIn 0.2s ease-out">
